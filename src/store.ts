...
const MOCK_CROPS: Crop[] = [
    {
        id: '1',
        name: 'Nendran Banana',
        variety: 'Organic Changeolikodan',
        location: 'Wayanad, Kerala',
        farmerName: 'John Doe',
        farmerRating: 4.8,
        storageUnitId: 'UNIT-104',
        quantity: 500,
        pricePerKg: 45,
        ...
        priority: 'HIGH',
        category: 'Fruits',
        monitoring: { temperature: 18.5, humidity: 92, aiRiskScore: 92, riskLevel: RiskLevel.HIGH, recommendation: 'Take action within 8 hrs.', explanation: 'Ethylene accumulation detected.', confidence: 94, spoilageHours: 24 },
        priceHistory: [{ date: 'Mon', price: 48 }, { date: 'Tue', price: 47 }, { date: 'Wed', price: 46 }],
        qaStatus: 'VERIFIED',
        listingImages: [
            '/images/nendran banana1.jpg',
            '/images/nendran banana2.jpg',
            '/images/nendran banana3.jpg'
        ],
    },
    {
        id: '2',
        name: 'Green Cardamom',
        variety: 'Alleppey Green',
        ...
        imageUrl: '/images/green cardamom.jpg',
        isPromoted: false,
        views: 42,
        inquiries: 6,
        visibilityScore: 70,
        ...
        priceHistory: [{ date: 'Mon', price: 1250 }, { date: 'Tue', price: 1230 }, { date: 'Wed', price: 1210 }],
        qaStatus: 'VERIFIED',
        listingImages: [
            '/images/green cardamom1.jpg',
            '/images/green cardamom2.jpg',
            '/images/green cardamom3.jpg'
        ],
    },
    {
        id: '3',
        ...
        imageUrl: '/images/black pepper1.jpg',
        isPromoted: true,
        views: 75,
        inquiries: 9,
        visibilityScore: 80,
        priority: 'HIGH',
        category: 'Spices',
        monitoring: { temperature: 22.0, humidity: 78, aiRiskScore: 55, riskLevel: RiskLevel.MODERATE, recommendation: 'Monitor humidity levels.', explanation: 'Moderate risk of moisture absorption.', confidence: 75, spoilageHours: 65 },
        priceHistory: [{ date: 'Mon', price: 440 }, { date: 'Tue', price: 445 }, { date: 'Wed', price: 450 }],
        qaStatus: 'NONE',
        listingImages: [
            '/images/black pepper1.jpg',
            '/images/black pepper2.jpg',
            '/images/black pepper3.jpg'
        ],
    },
    {
        id: '4',
        name: 'Ginger',
        variety: 'Wayanad Local',
        location: 'Wayanad, Kerala',
        farmerName: 'John Doe',
        farmerRating: 4.6,
        storageUnitId: 'N/A',
        ...
        priority: 'NORMAL',
        category: 'Spices',
        monitoring: { temperature: 24, humidity: 65, aiRiskScore: 20, riskLevel: RiskLevel.LOW, recommendation: 'Stable condition.', explanation: 'Optimal humidity and temperature.', confidence: 90, spoilageHours: 120 },
        priceHistory: [],
        qaStatus: 'NONE',
        listingImages: [
            '/images/ginger1.jpg',
    ...
    },
    {
        ...
        quantity: 800,
        pricePerKg: 25,
        harvestDate: '2023-11-08',
        imageUrl: '/images/tapioca.jpg',
        isPromoted: false,
        views: 28,
        inquiries: 3,
        visibilityScore: 50,
        priority: 'NORMAL',
        category: 'Tubers',
        monitoring: { temperature: 26, humidity: 70, aiRiskScore: 15, riskLevel: RiskLevel.LOW, recommendation: 'Sell soon.', explanation: 'Standard conditions.', confidence: 88, spoilageHours: 72 },
        priceHistory: [],
        qaStatus: 'NONE',
        listingImages: [
            '/images/tapioca1.jpg',
    ...
    // Expanded Data for Retailer Browsing
    {
        ...
        farmerName: 'Vinu George',
        farmerRating: 4.7,
        storageUnitId: 'UNIT-401',
        quantity: 300,
        pricePerKg: 550,
        ...
        priceHistory: [{ date: 'Mon', price: 540 }, { date: 'Tue', price: 545 }, { date: 'Wed', price: 550 }, { date: 'Thu', price: 550 }, { date: 'Fri', price: 550 }],
        qaStatus: 'VERIFIED',
        listingImages: [
            '/images/nutmeg1.jpg',
            '/images/nutmeg2.jpg',
    ...
    },
    {
        ...
        listingImages: [
            ...
            '/images/turmeric2.jpg',
            '/images/turmeric3.jpg'
        ],
    },
    {
        id: '8',
...
const MOCK_FORUM_POSTS: ForumPost[] = [
    {
        ...
        imageUrl: '/images/yellowing leaves.jpg',
        likes: 12,
        commentsCount: 4,
        commentsList: [
...
const MOCK_EXPERT_QUESTIONS: ExpertQuestion[] = [
    {
        ...
        history: [
            ...
            { id: '2', sender: 'Farmer', content: 'Attached photo of leaf', timestamp: '2 hours ago', type: 'image', attachmentUrl: '/images/yellowing leaves.jpg', isRead: true },
