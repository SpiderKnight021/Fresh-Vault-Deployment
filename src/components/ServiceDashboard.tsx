...
const ChatBubble: React.FC<{ msg: Message }> = ({ msg }) => {
    ...
    return (
        <div className={`flex flex-col ${isMe ? 'items-end' : 'items-start'} mb-3`}>
            <div className={`max-w-[85%] sm:max-w-[70%] rounded-2xl px-4 py-2.5 shadow-sm text-sm ${isMe
        ...
        setSelectedTask(prev => {
            ...
            return {
                ...
                metadata: {
                    ...prev.metadata,
                    tracking: {
                        ...(prev.metadata?.tracking || {}),
                        isActive: true,
                    },
                },
            } as ServiceTask; // assert full ServiceTask shape for TypeScript
        });
        // ...existing code...
    };
